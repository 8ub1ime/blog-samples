(function () {
  ...
  this.flipchartCss = '<link href="assets/timer.css" rel="stylesheet" type="text/css">';
  this.MegaTimer = function () {
    function g(a, b) {
      ...
      this.timerElements =
        this.cloneObject(C);
      this.tickEvent = [];
      m(window, "load", function (a) {
        return function () {
          return a.run()
        }
      }(this));
      m(window, "focus", function (a) {
        return function () {
          a.initType();
          return a.newTime(!0)
        }
    ...
    C = {
      ...
      days: {
        max: 1E3,
        min: 0, text: "\u0434\u043d\u0435\u0439", value: 0, view: !0, updated: !1
      }
    };
    ...
    g.prototype.setSeparators = function () {
      ...
      for (a = c = k = h.length - 1; 0 >= k ? 0 >= c : 0 <= c; a = 0 >= k ? ++c : --c) if (h[a]) {
        h[a] = !1;
        break
      }
      a = 0;
        ...
        switch (parseInt(this.params.type.currentType)) {
          ...
          case 3:
            if (null != this.params.type.params.weekdays && null != this.params.type.params.time && null != this.params.type.params.usertime &&
              ...
              f = null;
              b = l = 0;
              for (h = Math.floor(parseInt(this.params.type.params.hours) / 24); 0 <= h ? l <= h : l >= h; b = 0 <= h ? ++l : --l) if (d--, 0 > d && (d = 6), 1 === this.params.type.params.weekdays[d] && (a = new Date, a.setDate(a.getDate() - b), this.params.type.params.usertime || a.setTime(a.getTime() - 6E4 * e.getTimezoneOffset() + 6E4 * this.params.type.params.tz),
                  a.setHours(parseInt(c[0])), a.setMinutes(parseInt(c[1])), a.setSeconds(0), e.getTime() >= a.getTime() && (a.setHours(a.getHours() + parseInt(this.params.type.params.hours)), a.setMinutes(a.getMinutes() + parseInt(this.params.type.params.minutes)), a.getTime() >= e.getTime()))) {
                f = a;
                break
              }
              a = null;
    ...
    g.prototype.hexToRgb = function (a) {
      ...
      if (b = /^#?([a-f\d]{1,2})([a-f\d]{1,2})([a-f\d]{1,2})$/i.exec(a)) 1 === b[1].length && (b[1] += "" + b[1]), 1 === b[2].length && (b[2] += "" + b[2]), 1 === b[3].length && (b[3] += "" + b[3]), b = {
        r: parseInt(b[1],
          16), g: parseInt(b[2], 16), b: parseInt(b[3], 16), a: 1
      }; else if (0 === a.indexOf("rgb")) if (a = a.match(/\d+(\.\d+)?%?/g), 2 < a.length) {
    ...
    g.prototype.plateTick = function () {
      ...
      g = function (a) {
        return function (b, c) {
          var d, e;
          if (a.animationSupport() && a.params.design.params.animation) return e = a.params.design.params.effect, d = document.getElementById("timer-number-" + e + b + "-" + a.id + "-" + c), a.removeClass(d, "timer-" + e + "-animate"), requestAnimationFrame(function () {
            d.offsetLeft;
    ...
    m = function (a, b, c, d) {
      null == d && (d = !1);
      return null != a.addEventListener ? a.addEventListener(b, c, d) : null != a.attachEvent ? a.attachEvent("on" + b, c) : a["on" + b] = function () {
        return c()
      }
    };
    ...
    g.prototype.isEqualsNodes = function (a, b) {
      var c, d, e, f, g, h;
      if (null != a && null != b) if ("#text" === a.nodeName || "#text" === b.nodeName) {
